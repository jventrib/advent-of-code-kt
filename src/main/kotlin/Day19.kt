...
val orientations = Matrix3.identity().let { identity ->
    listOf(
        identity,
        identity.rotX(90),
        identity.rotX(180),
        ...
        identity.rotZ(180),
        identity.rotZ(-90),
        identity.rotX(90).rotY(90),
        identity.rotX(90).rotY(180),
        identity.rotX(90).rotY(-90),
        identity.rotX(90).rotZ(90),
        identity.rotX(90).rotZ(180),
        identity.rotX(90).rotZ(-90),
        identity.rotX(180).rotY(90),
        identity.rotX(180).rotY(-90),
        identity.rotX(180).rotZ(90),
        identity.rotX(180).rotZ(-90),
        identity.rotX(-90).rotY(90),
        identity.rotX(-90).rotY(-90),
        identity.rotX(-90).rotZ(90),
...
data class Matrix3(
    ...
    private fun Int.toRadian(): Double = (this.toDouble() / 180 * Math.PI)
