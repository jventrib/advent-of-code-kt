...
private fun solve(list: List<String>): Int {
    val queue = PriorityQueue<Step>(100)
...
data class Step(val amphipods: Set<Amphipod>, private var prev: Step?, var energy: Int) : Comparable<Step> {
    ...
    init {
        ...
        layout = amphisWithWorld.joinToString(lineSeparator(), transform = CharArray::concatToString)
    }
    ...
    fun printHistory() {
        ...
        println(history.joinToString(lineSeparator(), postfix = lineSeparator()))
